function Upper() {
  ...
  document.getElementById("output").innerHTML =
    "After uppercase: " + mytext.toUpperCase();
}

function Lower() {
  var mytext = document.getElementById("mytext").value;
  document.getElementById("output").innerHTML =
    "After lowercase: " + mytext.toLowerCase();
}
...
function Snake() {
  ...
  document.getElementById("output").innerHTML = "After Snake Case: " + mytext;
}
...
function Kebab() {
  ...
  document.getElementById("output").innerHTML = "After Kebab Case: " + mytext;
}
